...
export const typographyStyles = makeStyles(({ palette, ...theme }) => ({
  '@global': {
    ...
    '.text-17': { fontSize: '17px !important' },
    '.text-18': { fontSize: '18px !important' },
    '.text-19': { fontSize: '19px !important' },
    '.text-20': { fontSize: '20px !important' },
    '.text-21': { fontSize: '21px !important' },
    '.text-22': { fontSize: '22px !important' },
    '.text-23': { fontSize: '23px !important' },
    '.text-24': { fontSize: '24px !important' },
    '.text-25': { fontSize: '25px !important' },
    '.text-26': { fontSize: '26px !important' },
    '.text-27': { fontSize: '27px !important' },
    '.text-28': { fontSize: '28px !important' },
    '.text-29': { fontSize: '29px !important' },
